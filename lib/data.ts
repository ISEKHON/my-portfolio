export const PORTFOLIO = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "A fully-featured real-time messaging application with Firebase backend, Material Design 3 components, and end-to-end encrypted conversations.",
      tags: ["Kotlin", "Firebase", "Material Design 3"],
      status: "completed" as const,
      category: "Android",
      link: "https://github.com/isekhon",
      githubLink: "https://github.com/isekhon",
    ...
    },
    {
      ...
      description:
        "A comprehensive fitness tracking app leveraging Room Database and Kotlin Coroutines for smooth, asynchronous data management.",
      tags: ["Kotlin", "Room DB", "Coroutines"],
