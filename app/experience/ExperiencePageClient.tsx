  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-28 pb-24 px-5 max-w-4xl mx-auto">
        ...
        >
          {/* Vertical line */}
          <div className="absolute left-5 top-0 bottom-0 w-px bg-gradient-to-b from-[#8b5cf6] via-[#6366f1] to-transparent opacity-30" />
          ...
          <div className="space-y-10 pl-14">
            {PORTFOLIO.experience.map((entry, i) => (
              ...
              >
                {/* Dot */}
                <div className="absolute -left-[2.375rem] top-1.5 w-3.5 h-3.5 rounded-full border-2 border-[#8b5cf6] bg-[var(--bg-primary)]" />
